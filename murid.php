                ...
                <ul class="app-menu">
                            ...
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="ui-alerts.html" class="menu-link">
                                        <span class="menu-text">Pak Juned</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="menu-item">
                        <a href="#menuLayouts" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                            ...
                            <span class="menu-text">Guru Mapel</span>
                    ...
                    <li class="menu-item">
                        <a href="#menuIcons" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                            ...
                            <span class="menu-text"> Ketua Kelas </span>
                            <span class="menu-arrow"></span>
                        </a>
                            ...
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="icons-feather.html" class="menu-link">
                                        <span class="menu-text">Farel Dy Stancovic</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="menu-item">
                        <a href="#menuIcons" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                            <span class="menu-icon"><i class="bx bx-aperture"></i></span>
                            <span class="menu-text"> Wakil Kelas </span>
                            <span class="menu-arrow"></span>
                        </a>
                        <div class="collapse" id="menuIcons">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="icons-feather.html" class="menu-link">
                                        <span class="menu-text">Indra Nur Augusta</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuIcons">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="icons-feather.html" class="menu-link">
                                        <span class="menu-text">Hamzah Taazarah Huduri</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuIcons">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="icons-feather.html" class="menu-link">
                                        <span class="menu-text">Luthfian Adira</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="menu-item">
                        <a href="#menuIcons" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                            <span class="menu-icon"><i class="bx bx-aperture"></i></span>
                            <span class="menu-text"> Kesehatan </span>
                            <span class="menu-arrow"></span>
                        </a>
                        <div class="collapse" id="menuIcons">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="icons-feather.html" class="menu-link">
                                        <span class="menu-text">Muhammad Fahrum</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="menu-item">
                        <a href="#menuIcons" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                            <span class="menu-icon"><i class="bx bx-aperture"></i></span>
                            <span class="menu-text"> Kerapihan </span>
                            <span class="menu-arrow"></span>
                        </a>
                        <div class="collapse" id="menuIcons">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="icons-feather.html" class="menu-link">
                                        <span class="menu-text">Arya Praditya</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="menu-item">
                        <a href="#menuIcons" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                            <span class="menu-icon"><i class="bx bx-aperture"></i></span>
                            <span class="menu-text"> Kebersihan </span>
                            <span class="menu-arrow"></span>
                        </a>
                        <div class="collapse" id="menuIcons">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="icons-feather.html" class="menu-link">
                                        <span class="menu-text">Nova Khoirul Fatihin</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuIcons">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="icons-feather.html" class="menu-link">
                                        <span class="menu-text">Zyachman Baso</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        ...
                                        <h5 class="card-title mb-0">Percentase Kehadiranmu</h5>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        ...
                                        <h5 class="card-title mb-0">persentase Ketidakhadiranmu</h5>
                                    </div>
                                    <div class="row d-flex align-items-center mb-4">
                                        <div class="col-8">
                                            <h2 class="d-flex align-items-center mb-0">
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <span class="badge badge-soft-primary float-end">Jam pelajaran</span>
                                        <h5 class="card-title mb-0">Lihat Harian</h5>
                                    </div>
                                    <div class="row d-flex align-items-center mb-4">
                                        <div class="col-8">
                                            <h3 class="d-flex align-items-center mb-0">
                                                Mata pelajaran yang tidak kamu ikuti
                                            </h3>
                                        </div>
                                        <div class="col-4 text-end">
                                            <span class="text-muted">Matematika <i
                                                    class="mdi mdi-arrow-down text-danger"></i></span>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h5 class="text-muted mt-3">Percentase Kehadiranmu 1 semester</h5>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title d-inline-block">Data Kehadiran selama satu semester</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Top Kehadiran Siswa Rajin</h4>
                                    <p class="card-subtitle mb-4 font-size-13">Kelas XI.A WinBlez
                                    </p>
                                        ...
                                        <table class="table table-centered table-striped table-nowrap mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Peminatan favorit</th>
                                                    <th>Boarding or Fullday</th>
                                                    <th>Asal</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="assets/images/users/user.jpg" alt="table-user"
                                                            class="mr-2 avatar-xs rounded-circle">
                                                        <a href="javascript:void(0);"
                                                            class="text-body font-weight-semibold">Farel Dy
                                                            Stancovic</a>
                                                    </td>
                                                    <td>
                                                        92%
                                                ...
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="assets/images/users/user.jpg" alt="table-user"
                                                            class="mr-2 avatar-xs rounded-circle">
                                                        <a href="javascript:void(0);"
                                                            class="text-body font-weight-semibold">Sulthon Roziq
                                                            Aulia</a>
                                                    </td>
                                                    <td>
                                                        87%
                                                ...
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="assets/images/users/user.jpg" alt="table-user"
                                                            class="mr-2 avatar-xs rounded-circle">
                                                        <a href="javascript:void(0);"
                                                            class="text-body font-weight-semibold">Fadil</a>
                                                    </td>
                                                    <td>
                                                        86%
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="assets/images/users/user.jpg" alt="table-user"
                                                            class="mr-2 avatar-xs rounded-circle">
                                                        <a href="javascript:void(0);"
                                                            class="text-body font-weight-semibold">Gibran</a>
                                                    </td>
                                                    <td>
                                                        84%
                                                    </td>
